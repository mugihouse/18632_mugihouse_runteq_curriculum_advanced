...
RSpec.describe 'AdminArticles', type: :system do
  ...
  describe 'タグ編集画面' do
    ...
    it '「タグ」のパンくずをクリックした時にタグの一覧画面に遷移すること' do
      ...
      expect(current_path).to eq(admin_tags_path), 'パンくずのタグを押した時にタグ一覧に遷移していません'
    end
  end
end
